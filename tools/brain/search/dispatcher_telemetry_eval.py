...
def summarize_events(events: list[dict]) -> dict:
    ...
    return {
        ...
        "rescue_applied_rate": _safe_bool_rate(rescue_applied, total),
        "semantic_top_exact_hit_rate": _safe_bool_rate(semantic_exact_hits, total),
        "final_top_exact_hit_rate": _safe_bool_rate(final_exact_hits, total),
        "semantic_top_contract_hit_rate": _safe_bool_rate(semantic_contract_top_hits, total),
        "implementation_ranking_top_contract_hit_rate": _safe_bool_rate(ranked_contract_top_hits, total),
        "final_top_contract_hit_rate": _safe_bool_rate(final_contract_top_hits, total),
    }
