"""Read-side graph contract imported from ts-pack."""

from __future__ import annotations

try:
    from tree_sitter_language_pack import GRAPH_NODE_LABELS, GRAPH_REL_TYPES
...
def node_label(name: str) -> str:
    return GRAPH_NODE_LABELS[name]


def rel_type(name: str) -> str:
    return GRAPH_REL_TYPES[name]
