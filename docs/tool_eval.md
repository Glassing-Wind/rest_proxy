...
| `get_app_flow_summary` | **Niche/High** | Continue live validation before promotion. | **Fixed/Tested**: Route catalog and literal-call fallbacks prefer route-qualified UI-to-backend paths before coarse service rows. |
